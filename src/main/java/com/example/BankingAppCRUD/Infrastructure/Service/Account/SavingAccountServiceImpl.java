...
public class SavingAccountServiceImpl implements AccountService<SavingAccount> {
    ...
    @Autowired
    SavingAccountServiceImpl(SavingAccountJPARepository savingAccountRepository , InterestRateService interestRateService , NumberGeneratorBean numberGeneratorBean) {
